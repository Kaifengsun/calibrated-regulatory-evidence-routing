...
| TASK-052 | Implement `src/evidence_routing/go_no_go.py::compute_signal_1` through `compute_signal_5`, `evaluate_qualitative_gates`, and `make_decision`; require all qualitative gates and at least four quantitative signals. | ✅ | 2026-07-27 |
